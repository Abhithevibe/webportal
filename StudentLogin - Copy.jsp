			...
			<div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-navbar-collapse">
                    <ul class="nav navbar-nav main-navbar-nav">
                        ...
                        <li><a href="mytemplate/category.html" title="">CATEGORY</a></li>
    ...
    <main class="dsite-main">
        ...
        <form action="StudentChkLogin.jsp">
						...
						<table border="10" cellspacing="10" cellpadding="10">
						   <caption><font size="5" face="Ariel">Student Login </font></caption>
						   <tr><td>Student Login ID</td><td><input type="text" name="slid"></td></tr>
						   <tr><td>Password</td><td><input type="password" name="pwd"></td></tr>
						   <tr><td><input type="submit" value="Login"></td><td><a href="ForgetPassword.jsp">Forget Password?</a></td></tr>
						   <tr><td>New User?</td><td><a href="StudentReg.jsp">Student Registration</a></td></tr>
							</table>
							</center>
							</form>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="box">
                            <h3>READ THIS!</h3>
                            <p>Kindly fill every entry carefully during registration. This information will be used to decide your eligibility for a company.</p>
